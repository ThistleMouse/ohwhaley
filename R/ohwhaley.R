#' The Whale Message Function
#'
#'@description
#'Summon a whale for a customisable pick-me-up message.
#'
#'
#' @param what string; This is whatever you would like the whale to say.
#'
#' @return A whale with a message.
#' @export
#'
#' @examples
#' say("You're very whale-come.")
#' say("You got this!")
#' say("Just keep swimming, swimming, swimming...")
say <- function(what){
